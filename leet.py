...
# VACATION_RATE = RandomForestRegressor(201)

# VACATION_RATE.fit(X,Y)

train_x,val_x,train_y,val_y = train_test_split(X,Y,random_state = 1)

VACATION_RATE = XGBRegressor(n_estimators=201, learning_rate=0.05)
VACATION_RATE.fit(train_x, train_y, 
